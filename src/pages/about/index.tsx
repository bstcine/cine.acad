  ...
  return (
    <div className="container about-page">
      <div className="js-toc-content">
        ...
        <h2 id="story">品牌故事</h2>
        <p>善恩（CINE）是英文Chinese in New England Education的首字母缩写。</p>
        <p>
          新英格兰（New
          England）地区是美国东北部的一小片区域，包括缅因州、新罕布什尔州、佛蒙特州、马萨诸塞州、罗得岛州和康涅狄格州。这片区域是当初逃离英国并梦想在新大陆建立新家园的那群清教徒最初登陆美洲大陆的最早定居点。他们把这块地区命名为新英格兰，一方面是既表明自己源自于英格兰，但同时又有别于英格兰，故名新英格兰。因为这片土地承载着清教徒们逃离故土并在新天地开辟新家园的所有期望，所以新英格兰常象征着希望与探索。
        </p>
        <p>
          善恩教育的创始人周立伟先生于2013年年底在波士顿创立善恩教育，就是想秉承当年清教徒在北美开天辟地之精神 —
          帮中国人在世界教育的高低波士顿建立一个桥头堡，将这里的优质教育资源嫁接给世界各地的华人学子，让他们有机会接受到最优质的教育。
        </p>
        <p>
          另外，善恩也有“秉持善心，感恩托付”的涵义。善恩认为，教育不是普通的商业。因为教育的对象不是商品，而是承载着家庭希望的孩子的教育。所以，唯有秉持善心，才能做好教育；唯有以感恩之心面对信托，才能不辱使命。
        </p>
        <h2 id="rule">学院规章制度</h2>
        <p>善恩的老师和学生来自世界各地，他们遵循的文化和法规多元各异。为保障学院的正常运作，特制定本规则。</p>
        <p>1、关于约课。约课需要提前至少48小时。善恩学院将无法为学生预约48小时以内的课程。</p>
        <p>Q：为什么要提前48小时约课？</p>
        <p>A：考虑到时差和善恩学院外教老师紧张的日程， 48小时是预约所需的最低提前量。</p>
        <p>
        ...
        <p>Q：为什么没有上课也还要扣除课时费？</p>
        <p>
          A：这是国际通行做法。对于专业从事辅导的外教老师而言，他的时间就是收入。一旦把某个时间段安排给了某个学生，意味着这个时间段就被独占。如果在开课前临时取消，老师无法找到新的学生。所以，按照国外的通行的办法，学生因为自身原因临时取消课程，学生仍然需支付相应费用。
        </p>
        <p>
        ...
        <p>Q：如果开课时间因故延迟了，为什么不能延迟下课时间？</p>
        <p>
          A：因为很有可能后面紧接着还有安排。所以我们才说老师有权按时下课。在实际操作中，只要情况允许，老师一般也愿意延迟下课。请学生学会和外教进行良好的沟通。这些能力对于将来赴美留学也是很有价值的。
        </p>
        <p>
        ...
        <p>Q：为什么加急服务需要双倍课时？</p>
        <p>
          A：在国外，一切服务都需要提前预约。这是对服务者的尊重，也是为了确保被服务对象能接收到良好的服务。当学生提出加急服务的请求时，外教常常需要牺牲原定的休息时间来完成任务，或者需要在更大的时间压力下工作。因此，加急服务需要额外的财务补偿，这在国外也是属于通常做法。
        </p>
