  ...
  return (
    <div className="container about-page">
      <div className="js-toc-content">
        ...
        <p>善恩对外教有着极其严格的管理。</p>
        <p>首先在招聘的环节，善恩严把质量关。被善恩录用的教员普遍具有非常优秀的学术背景（一般都有名校硕士、博士的教育背景），具有优秀的沟通能力（每一个外教被正式录用之前需要经过两轮面试）、以及足够优秀的客户评价（可以通过第三方网站的客户评价记录，或者要求教员提供客户信息给由我们进行验证）。</p>
        <p>其次，我们对每一位录用的外教进行岗前培训。让外教了解中国学生的学习方式和在学习中容易遇到的常见问题，以使外教的教学能够最大程度贴合中国学生的需求。</p>
        <p>这个培训还一直延续到授课过程中。我们要求每一位教员对授课的前三次进行录像并提供给善恩的外教管理团队进行审阅。善恩团队将对外教在授课中存在的问题进行及时的反馈和建议，并要求教员作出相应的调整。</p>
        <p>在整个授课过程中，我们都会要求用户对外教的每一次授课都进行评价和反馈。善恩将第一时间获悉用户的反馈意见。在进行核实、分析和评估之后，我们将约谈外教，要求教员作出相应的调整，确保教学授课保持正轨。</p>
        <p>另外，善恩学院的所有公开课，其内容和进度安排都是善恩专业团队和外教共同协商而定。如果是针对特定学生的个性化课程，则更是由善恩方面首先搜集学生的基础信息，并将此基础信息分享给外教，外教提出授课计划后交由善恩审核，批准后才得以实施。</p>
        <h3 id="7_2">如何评估课程的效果</h3>
        <p>绝大部分情况下，学生是在遇到特定问题的情况下聘请教员进行辅导的。授课的效果很容易评估：学校的作业质量是否有提升？老师的评分是否有提高？或者原来不理解的知识现在明白了？</p>
        <p>但有些时候，有些课程不太容易看到立竿见影的效果，或者效果不太好评价。例如，英文的阅读和写作能力。善恩认为，阅读和写作的能力的提升是一个需要长期坚持、持之以恒的过程，不能期望短期内有飞速的提高。但有没有效果，学生自己最容易感受到。也正是基于此理由，我们才要求学生在每次学习之后，都及时向善恩反馈上课的感受。我们一再强调：善恩学院的课程，当且仅当学生觉得物有所值时才继续。</p>
